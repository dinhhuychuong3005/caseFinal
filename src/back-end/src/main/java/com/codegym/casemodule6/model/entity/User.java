...
public class User {
    ...
    //0: chưa đang kí CCDV, 1: đã đc duyệt CCDV; 2: Busy không CCDV, 3: chờ duyệt
    private int statusCCDV;

    //1: Đăng kí thành công, 0: Bị admin block
